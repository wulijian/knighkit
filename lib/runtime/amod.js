...
define(function (require, exports, module) {
     ...
     */
    var handleSub = function (sub, curModule, mod) {
     ...
     * @returns {*|___template___应该是一个promise对象|str|String}
     */
    exports.handleSyncSub = function (sub, curModule, mod) {
        return handleSub(sub, curModule, mod)
     ...
     * @returns {*|___template___应该是一个promise对象|str|String}
     */
    exports.handleASyncSub = function (sub, curModule, mod) {
        return handleSub(sub, curModule, mod)
