...
define(function (require, exports, module) {
    ...
    if (q === null && (typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document)) {//使用requirejs时，q不是null
        q = Q;
    }
    ...
    var parseSync = function (htmlCode, subModules, defer, curModule) {
        ...
        syncSubs.forEach(function (sub) {
            requireMod(curModule, sub.module, function (mod, subModuleId) {
                syncRender.push(
                    amod.handleSyncSub(sub, curModule, mod, subModuleId)
     ...
     */
    var resolveAsync = function (Subs, curModule, syncsubs) {
        ...
        asyncReplaceBegin.promise.then(function (errhandler) {
            setImmediate(function () {
                ...
                Subs
                    ...
                    .forEach(function (sub) {
                        requireMod(curModule, sub.module, function (mod, subModuleId) {
                            amod.handleASyncSub(sub, curModule, mod, subModuleId)
     ...
     */
    var parseAsync = function (htmlCode, subModules, defer, curModule, subs) {
        ...
        defer.resolve({html: htmlCode, async: resolveAsync(subModules, curModule, subs)});
    ...
    exports.parse = function (htmlCodeFn, curModule) {
        return function (data) {
            ...
            return parseSync(htmlCode, subModules, defer, curModule)//同步模块，直接替换原字符串中的匹配部分
                .then(function (synRe) {
                    return parseAsync(synRe.code, subModules, defer, curModule, synRe.subs); //异步模块，直接展示现在的模块，然后按照优先级渲染模块
                })
        }
    };
    ((typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document) ? window : global).___subModule___ = exports;
});